...
-(NSArray*)getProjectedPosOn:(int) eigenID{
  vector<ModeAnalysis::xyz> pos_cpp = (*(ModeAnalysis*)_cppModeAnalysis).projectPosOnEigenVec(eigenID);
  NSMutableArray* ar = [[NSMutableArray alloc] init];
  for (auto pos:pos_cpp) {
    NSMutableArray* pos_ar = [[NSMutableArray alloc] init];
    [pos_ar addObject:[NSNumber numberWithDouble:pos.x]];
    [pos_ar addObject:[NSNumber numberWithDouble:pos.y]];
    [pos_ar addObject:[NSNumber numberWithDouble:pos.z]];
...
//利用は見送り ModeAnalysis::xyzとObjのxyzの変換がうまくいかない
-(NSArray*)array_xyzToNSArray:(vector<ModeAnalysis::xyz>*) vertices_cpp{
  NSMutableArray* ar = [[NSMutableArray alloc] init];
  for (auto pos:*vertices_cpp) {
    NSMutableArray* pos_ar = [[NSMutableArray alloc] init];
    [pos_ar addObject:[NSNumber numberWithDouble:pos.x]];
    [pos_ar addObject:[NSNumber numberWithDouble:pos.y]];
    [pos_ar addObject:[NSNumber numberWithDouble:pos.z]];
